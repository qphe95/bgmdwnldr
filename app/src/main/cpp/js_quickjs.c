...
static void init_browser_environment(JSContext *ctx, AAssetManager *asset_mgr) {
    ...
    const char *dom_js = 
        ...
        ""
        // HTMLScriptElement - enhanced with event handlers
        ...
        "  set: function(v) { this._src = String(v||''); if(this._src && typeof setTimeout==='function'){var self=this;setTimeout(function(){self._loaded=true;if(typeof self.onload==='function'){try{self.onload({type:'load',target:self});}catch(e){}}},1);} },"
        "  configurable: true, enumerable: true"
        "});"
        "Object.defineProperty(HTMLScriptElement.prototype, 'type', {"
        "  get: function() { return this._type; },"
        "  set: function(v) { this._type = String(v||''); },"
        "  configurable: true, enumerable: true"
        "});"
