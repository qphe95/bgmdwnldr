...
static const char BROWSER_STUBS_JS[] = 
    ...
    ""
    /* =========================================================================
     * WINDOW OBJECT - Must use globalThis to ensure var declarations propagate
     * =========================================================================
     * In a real browser, `window` IS the global object, so `var x = 1` 
     * automatically makes `window.x === 1`. We achieve this by using globalThis
     * as the window object and adding properties to it.
     */
    "(function() {"
    "  // Use globalThis as the actual global object (this ensures var declarations work)"
    ...
    "  g.pageYOffset = 0;"
    "  g.print = function() {};"
    "  g.requestAnimationFrame = function(cb) { if (typeof cb === 'function') { try { cb(performance.now()); } catch(e) {} } return 0; };"
    "  g.cancelAnimationFrame = function() {};"
    "  g.requestIdleCallback = function(cb) { if (typeof cb === 'function') { try { cb({ didTimeout: false, timeRemaining: function() { return 50; } }); } catch(e) {} } return 0; };"
    "  g.cancelIdleCallback = function() {};"
    "  g.captureEvents = function() {};"
    "  g.releaseEvents = function() {};"
    "  g.getComputedStyle = function() { return new CSSStyleDeclaration(); };"
    "  g.getSelection = function() { return { anchorNode: null, anchorOffset: 0, focusNode: null, focusOffset: 0, isCollapsed: true, rangeCount: 0, type: 'None', toString: function() { return ''; }, removeAllRanges: function() {}, addRange: function() {}, getRangeAt: function() { return null; }, deleteFromDocument: function() {} }; };"
    "  g.matchMedia = function(q) { return { matches: false, media: q, addListener: function() {}, removeListener: function() {}, addEventListener: function() {}, removeEventListener: function() {}, dispatchEvent: function() { return false; }, onchange: null }; };"
    "  g.queueMicrotask = function(cb) { if (typeof cb === 'function') { try { cb(); } catch(e) {} } };"
    "  g.btoa = function(str) {"
    ...
    "  "
    "  // Expose DOM constructors on window"
    ...
    "  g.CSS = CSS;"
    "  g.customElements = { define: function() {}, get: function() { return undefined; }, whenDefined: function() { return Promise.resolve(); }, upgrade: function() {}, observe: function() {} };"
    "  "
    "  // Make sure localStorage and sessionStorage are on window"
    "  g.localStorage = localStorage;"
    "  g.sessionStorage = sessionStorage;"
    "  "
    "  // Also set globalThis for modern JS"
    "  if (typeof globalThis === 'undefined') {"
    "    g.globalThis = g;"
    "  }"
    "  "
    "  // Ensure 'window' is available as a global variable"
    "  // This allows var declarations to be accessed via window.xxx"
    "  try {"
    ...
    "})();"
    ""
    "if (typeof window === 'undefined') { var window = globalThis || self || this; }"
    /* performance */
