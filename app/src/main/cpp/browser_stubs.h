...
static const char BROWSER_STUBS_JS[] = 
    ...
    ""
    /* CSSStyleDeclaration */
    "function CSSStyleDeclaration() { this.cssText = ''; }"
    ...
    ""
    /* XMLHttpRequest with signature capture hook */
    "var _capturedSignatures = [];"
    "var _captureSignature = function(url) {"
    "  if (typeof url === 'string' && url.indexOf('googlevideo.com') >= 0) {"
    "    var sigMatch = url.match(/[?&]sig=([^&]+)/);"
    "    if (sigMatch && sigMatch[1]) {"
    "      _capturedSignatures.push({url: url, sig: sigMatch[1]});"
    "    }"
    "  }"
    "  return url;"
    "};"
    ...
    "  this._url = _captureSignature(u);"
    "  this.readyState = 1;"
    "  if (this.onreadystatechange) this.onreadystatechange();"
    "};"
    "XMLHttpRequest.prototype.send = function(b) { this.readyState = 4; this.status = 0; if (this.onreadystatechange) this.onreadystatechange(); if (this.onload) this.onload(); if (this.onloadend) this.onloadend(); };"
    "XMLHttpRequest.prototype.abort = function() { this.readyState = 0; if (this.onabort) this.onabort(); };"
